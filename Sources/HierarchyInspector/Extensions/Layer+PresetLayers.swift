...
extension HierarchyInspector.Layer {
    ...
    public static let collectionViews    = HierarchyInspector.Layer(name: "CollectionViews")    { $0 is UICollectionView }
    ...
    public static let progressIndicators = HierarchyInspector.Layer(name: "ProgressIndicators") { $0 is UIProgressView }
    public static let scrollViews        = HierarchyInspector.Layer(name: "Scroll views")       { $0 is UIScrollView }
    public static let segmentedControls  = HierarchyInspector.Layer(name: "SegmentedControls")  { $0 is UISegmentedControl || $0.superview is UISegmentedControl }
    ...
    public static let textFields         = HierarchyInspector.Layer(name: "TextFields")         { $0 is UITextField || $0.superview is UITextField }
    public static let textViews          = HierarchyInspector.Layer(name: "TextViews")          { $0 is UITextView || $0.superview is UITextView }
    public static let textInputs         = HierarchyInspector.Layer(name: "Text inputs")        { $0 is UIKeyInput || $0.superview is UIKeyInput }
    public static let webViews           = HierarchyInspector.Layer(name: "WebViews")           { $0 is WKWebView || $0.superview is WKWebView }
