//
//  ElementInspector.AttributesInspectorViewController.swift
//  HierarchyInspector
//
...
protocol ElementInspectorAttributesInspectorViewControllerDelegate: OperationQueueManagerProtocol {
...
extension ElementInspector {
    final class AttributesInspectorViewController: ElementInspectorPanelViewController {
        
        // MARK: - Properties
        
        weak var delegate: ElementInspectorAttributesInspectorViewControllerDelegate?
        ...
        static func create(viewModel: AttributesInspectorViewModelProtocol) -> ElementInspector.AttributesInspectorViewController {
            let viewController = ElementInspector.AttributesInspectorViewController()
...
private extension ElementInspector.AttributesInspectorViewController {
...
extension ElementInspector.AttributesInspectorViewController {
...
extension ElementInspector.AttributesInspectorViewController: OperationQueueManagerProtocol {
...
extension ElementInspector.AttributesInspectorViewController: AttributesInspectorViewCodeDelegate {
