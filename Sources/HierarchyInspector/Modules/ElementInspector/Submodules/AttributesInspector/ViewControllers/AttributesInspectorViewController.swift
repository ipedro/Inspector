...
final class AttributesInspectorViewController: ElementInspectorPanelViewController {
    ...
    weak var delegate: AttributesInspectorViewControllerDelegate?
    ...
    static func create(viewModel: AttributesInspectorViewModelProtocol) -> AttributesInspectorViewController {
        let viewController = AttributesInspectorViewController()
...
private extension AttributesInspectorViewController {
...
extension AttributesInspectorViewController {
...
extension AttributesInspectorViewController: OperationQueueManagerProtocol {
...
extension AttributesInspectorViewController: AttributesInspectorViewCodeDelegate {
