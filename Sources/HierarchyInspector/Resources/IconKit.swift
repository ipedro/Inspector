...
//  HierarchyInspector
//
//  Created by Pedro Almeida on Oct 14, 2020.
//
...
class IconKit: NSObject {
    ...
    class func drawListBulletIndent(color: UIColor = .black, frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit) {
        ...
        icon.close()
        color.setFill()
        icon.move(to: CGPoint(x: 2.8, y: 7.25))
        icon.addCurve(to: CGPoint(x: 3.8, y: 6.25), controlPoint1: CGPoint(x: 3.35, y: 7.25), controlPoint2: CGPoint(x: 3.8, y: 6.8))
        icon.addCurve(to: CGPoint(x: 2.8, y: 5.25), controlPoint1: CGPoint(x: 3.8, y: 5.7), controlPoint2: CGPoint(x: 3.35, y: 5.25))
        icon.addCurve(to: CGPoint(x: 1.79, y: 6.25), controlPoint1: CGPoint(x: 2.24, y: 5.25), controlPoint2: CGPoint(x: 1.79, y: 5.7))
        icon.addCurve(to: CGPoint(x: 2.8, y: 7.25), controlPoint1: CGPoint(x: 1.79, y: 6.8), controlPoint2: CGPoint(x: 2.24, y: 7.25))
        icon.close()
        icon.move(to: CGPoint(x: 6.11, y: 6.98))
        icon.addLine(to: CGPoint(x: 15.48, y: 6.98))
        icon.addCurve(to: CGPoint(x: 16.21, y: 6.25), controlPoint1: CGPoint(x: 15.89, y: 6.98), controlPoint2: CGPoint(x: 16.21, y: 6.65))
        icon.addCurve(to: CGPoint(x: 15.48, y: 5.52), controlPoint1: CGPoint(x: 16.21, y: 5.85), controlPoint2: CGPoint(x: 15.89, y: 5.52))
        icon.addLine(to: CGPoint(x: 6.11, y: 5.52))
        icon.addCurve(to: CGPoint(x: 5.38, y: 6.25), controlPoint1: CGPoint(x: 5.7, y: 5.52), controlPoint2: CGPoint(x: 5.38, y: 5.85))
        icon.addCurve(to: CGPoint(x: 6.11, y: 6.98), controlPoint1: CGPoint(x: 5.38, y: 6.65), controlPoint2: CGPoint(x: 5.7, y: 6.98))
        icon.close()
        icon.move(to: CGPoint(x: 4.59, y: 12.5))
        icon.addCurve(to: CGPoint(x: 5.59, y: 11.5), controlPoint1: CGPoint(x: 5.14, y: 12.5), controlPoint2: CGPoint(x: 5.59, y: 12.05))
        icon.addCurve(to: CGPoint(x: 4.59, y: 10.5), controlPoint1: CGPoint(x: 5.59, y: 10.95), controlPoint2: CGPoint(x: 5.14, y: 10.5))
        icon.addCurve(to: CGPoint(x: 3.58, y: 11.5), controlPoint1: CGPoint(x: 4.03, y: 10.5), controlPoint2: CGPoint(x: 3.58, y: 10.95))
        icon.addCurve(to: CGPoint(x: 4.59, y: 12.5), controlPoint1: CGPoint(x: 3.58, y: 12.05), controlPoint2: CGPoint(x: 4.03, y: 12.5))
        icon.close()
        icon.move(to: CGPoint(x: 7.9, y: 12.23))
        icon.addLine(to: CGPoint(x: 17.28, y: 12.23))
        icon.addCurve(to: CGPoint(x: 18, y: 11.5), controlPoint1: CGPoint(x: 17.68, y: 12.23), controlPoint2: CGPoint(x: 18, y: 11.91))
        icon.addCurve(to: CGPoint(x: 17.28, y: 10.78), controlPoint1: CGPoint(x: 18, y: 11.1), controlPoint2: CGPoint(x: 17.68, y: 10.78))
        icon.addLine(to: CGPoint(x: 7.9, y: 10.78))
        icon.addCurve(to: CGPoint(x: 7.17, y: 11.5), controlPoint1: CGPoint(x: 7.49, y: 10.78), controlPoint2: CGPoint(x: 7.17, y: 11.1))
        icon.addCurve(to: CGPoint(x: 7.9, y: 12.23), controlPoint1: CGPoint(x: 7.17, y: 11.9), controlPoint2: CGPoint(x: 7.49, y: 12.23))
        icon.close()
        context.saveGState()
        context.translateBy(x: 3, y: 6)
        icon.fill()
        ...
        context.addRect(icon.bounds.insetBy(dx: -10, dy: -10))
