...
//  HierarchyInspector
//
//  Created by Pedro Almeida on Oct 12, 2020.
//
...
class IconKit: NSObject {
    ...
    class func drawColorGrid(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 32, height: 16), resizing: ResizingBehavior = .aspectFit) {
        ...
        /// Background Color
        UIColor.lightGray.withAlphaComponent(0.75).setFill()
        context.fill(context.boundingBoxOfClipPath)
        
        let color = UIColor(white: 0, alpha: 0.25)
    ...
    class func drawListBulletIndent(color: UIColor = .black, frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit) {
        ...
        /// icon
        let icon = UIBezierPath()
        icon.move(to: CGPoint(x: 1.01, y: 1.99))
        icon.addCurve(to: CGPoint(x: 2.01, y: 1), controlPoint1: CGPoint(x: 1.56, y: 1.99), controlPoint2: CGPoint(x: 2.01, y: 1.55))
        icon.addCurve(to: CGPoint(x: 1.01, y: 0), controlPoint1: CGPoint(x: 2.01, y: 0.45), controlPoint2: CGPoint(x: 1.56, y: 0))
        icon.addCurve(to: CGPoint(x: 0, y: 1), controlPoint1: CGPoint(x: 0.45, y: 0), controlPoint2: CGPoint(x: 0, y: 0.45))
        icon.addCurve(to: CGPoint(x: 1.01, y: 1.99), controlPoint1: CGPoint(x: 0, y: 1.55), controlPoint2: CGPoint(x: 0.45, y: 1.99))
        icon.close()
        icon.move(to: CGPoint(x: 4.31, y: 1.72))
        icon.addLine(to: CGPoint(x: 13.69, y: 1.72))
        icon.addCurve(to: CGPoint(x: 14.42, y: 1), controlPoint1: CGPoint(x: 14.09, y: 1.72), controlPoint2: CGPoint(x: 14.42, y: 1.4))
        icon.addCurve(to: CGPoint(x: 13.69, y: 0.27), controlPoint1: CGPoint(x: 14.42, y: 0.6), controlPoint2: CGPoint(x: 14.09, y: 0.27))
        icon.addLine(to: CGPoint(x: 4.31, y: 0.27))
        icon.addCurve(to: CGPoint(x: 3.59, y: 1), controlPoint1: CGPoint(x: 3.91, y: 0.27), controlPoint2: CGPoint(x: 3.59, y: 0.59))
        icon.addCurve(to: CGPoint(x: 4.31, y: 1.72), controlPoint1: CGPoint(x: 3.59, y: 1.4), controlPoint2: CGPoint(x: 3.91, y: 1.72))
        icon.close()
        icon.move(to: CGPoint(x: 2.8, y: 6.25))
        icon.addCurve(to: CGPoint(x: 3.8, y: 5.25), controlPoint1: CGPoint(x: 3.35, y: 6.25), controlPoint2: CGPoint(x: 3.8, y: 5.8))
        icon.addCurve(to: CGPoint(x: 2.8, y: 4.25), controlPoint1: CGPoint(x: 3.8, y: 4.7), controlPoint2: CGPoint(x: 3.35, y: 4.25))
        icon.addCurve(to: CGPoint(x: 1.79, y: 5.25), controlPoint1: CGPoint(x: 2.24, y: 4.25), controlPoint2: CGPoint(x: 1.79, y: 4.7))
        icon.addCurve(to: CGPoint(x: 2.8, y: 6.25), controlPoint1: CGPoint(x: 1.79, y: 5.8), controlPoint2: CGPoint(x: 2.24, y: 6.25))
        icon.close()
        icon.move(to: CGPoint(x: 6.11, y: 5.98))
        icon.addLine(to: CGPoint(x: 15.48, y: 5.98))
        icon.addCurve(to: CGPoint(x: 16.21, y: 5.25), controlPoint1: CGPoint(x: 15.89, y: 5.98), controlPoint2: CGPoint(x: 16.21, y: 5.65))
        icon.addCurve(to: CGPoint(x: 15.48, y: 4.52), controlPoint1: CGPoint(x: 16.21, y: 4.85), controlPoint2: CGPoint(x: 15.89, y: 4.52))
        icon.addLine(to: CGPoint(x: 6.11, y: 4.52))
        icon.addCurve(to: CGPoint(x: 5.38, y: 5.25), controlPoint1: CGPoint(x: 5.7, y: 4.52), controlPoint2: CGPoint(x: 5.38, y: 4.85))
        icon.addCurve(to: CGPoint(x: 6.11, y: 5.98), controlPoint1: CGPoint(x: 5.38, y: 5.65), controlPoint2: CGPoint(x: 5.7, y: 5.98))
        icon.close()
        icon.move(to: CGPoint(x: 4.59, y: 10.5))
        icon.addCurve(to: CGPoint(x: 5.59, y: 9.5), controlPoint1: CGPoint(x: 5.14, y: 10.5), controlPoint2: CGPoint(x: 5.59, y: 10.05))
        icon.addCurve(to: CGPoint(x: 4.59, y: 8.5), controlPoint1: CGPoint(x: 5.59, y: 8.95), controlPoint2: CGPoint(x: 5.14, y: 8.5))
        icon.addCurve(to: CGPoint(x: 3.58, y: 9.5), controlPoint1: CGPoint(x: 4.03, y: 8.5), controlPoint2: CGPoint(x: 3.58, y: 8.95))
        icon.addCurve(to: CGPoint(x: 4.59, y: 10.5), controlPoint1: CGPoint(x: 3.58, y: 10.05), controlPoint2: CGPoint(x: 4.03, y: 10.5))
        icon.close()
        icon.move(to: CGPoint(x: 7.9, y: 10.23))
        icon.addLine(to: CGPoint(x: 17.28, y: 10.23))
        icon.addCurve(to: CGPoint(x: 18, y: 9.5), controlPoint1: CGPoint(x: 17.68, y: 10.23), controlPoint2: CGPoint(x: 18, y: 9.91))
        icon.addCurve(to: CGPoint(x: 17.28, y: 8.78), controlPoint1: CGPoint(x: 18, y: 9.1), controlPoint2: CGPoint(x: 17.68, y: 8.78))
        icon.addLine(to: CGPoint(x: 7.9, y: 8.78))
        icon.addCurve(to: CGPoint(x: 7.17, y: 9.5), controlPoint1: CGPoint(x: 7.49, y: 8.78), controlPoint2: CGPoint(x: 7.17, y: 9.1))
        icon.addCurve(to: CGPoint(x: 7.9, y: 10.23), controlPoint1: CGPoint(x: 7.17, y: 9.9), controlPoint2: CGPoint(x: 7.49, y: 10.23))
        icon.close()
        context.saveGState()
