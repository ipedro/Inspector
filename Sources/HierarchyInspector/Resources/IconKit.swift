...
class IconKit: NSObject {
    ...
    class func drawVerticalAlignmentTop(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 15, height: 11), resizing: ResizingBehavior = .aspectFit) {
        ...
        let verticalAlignmentTop2 = UIBezierPath()
        verticalAlignmentTop2.move(to: CGPoint(x: 3, y: 1))
        verticalAlignmentTop2.addLine(to: CGPoint(x: 3, y: 10))
        verticalAlignmentTop2.addLine(to: CGPoint(x: 12, y: 10))
        verticalAlignmentTop2.addLine(to: CGPoint(x: 12, y: 1))
        verticalAlignmentTop2.addLine(to: CGPoint(x: 3, y: 1))
        verticalAlignmentTop2.close()
        verticalAlignmentTop2.move(to: CGPoint(x: 13, y: 11))
        verticalAlignmentTop2.addLine(to: CGPoint(x: 2, y: 11))
        verticalAlignmentTop2.addLine(to: CGPoint(x: 2, y: 1))
        verticalAlignmentTop2.addLine(to: CGPoint(x: 0, y: 1))
        verticalAlignmentTop2.addLine(to: CGPoint.zero)
        verticalAlignmentTop2.addLine(to: CGPoint(x: 15, y: 0))
        verticalAlignmentTop2.addLine(to: CGPoint(x: 15, y: 1))
        verticalAlignmentTop2.addLine(to: CGPoint(x: 13, y: 1))
        verticalAlignmentTop2.addLine(to: CGPoint(x: 13, y: 11))
        verticalAlignmentTop2.close()
        context.saveGState()
        UIColor.black.setFill()
        verticalAlignmentTop2.fill()
    ...
    class func drawVerticalAlignmentCenter(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 15, height: 11), resizing: ResizingBehavior = .aspectFit) {
        ...
        let verticalAlignmentCenter2 = UIBezierPath()
        verticalAlignmentCenter2.move(to: CGPoint(x: 12.96, y: 0))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 12.96, y: 5))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 14.93, y: 5))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 14.93, y: 6))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 12.96, y: 6))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 12.96, y: 11))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 1.96, y: 11))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 1.96, y: 6))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 0, y: 6))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 0, y: 5))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 1.96, y: 5))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 1.96, y: 0))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 12.96, y: 0))
        verticalAlignmentCenter2.close()
        verticalAlignmentCenter2.move(to: CGPoint(x: 11.96, y: 6))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 2.96, y: 6))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 2.96, y: 10))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 11.96, y: 10))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 11.96, y: 6))
        verticalAlignmentCenter2.close()
        verticalAlignmentCenter2.move(to: CGPoint(x: 11.96, y: 1))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 2.96, y: 1))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 2.96, y: 5))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 11.96, y: 5))
        verticalAlignmentCenter2.addLine(to: CGPoint(x: 11.96, y: 1))
        verticalAlignmentCenter2.close()
        context.saveGState()
        UIColor.black.setFill()
        verticalAlignmentCenter2.fill()
        context.restoreGState()
    ...
    class func drawVerticalAlignmentBottom(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 15, height: 11), resizing: ResizingBehavior = .aspectFit) {
        ...
        let verticalAlignmentBottom2 = UIBezierPath()
        verticalAlignmentBottom2.move(to: CGPoint(x: 0, y: 11))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 0, y: 10))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 2, y: 10))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 2, y: 0))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 13, y: 0))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 13, y: 10))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 15, y: 10))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 15, y: 11))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 0, y: 11))
        verticalAlignmentBottom2.close()
        verticalAlignmentBottom2.move(to: CGPoint(x: 12, y: 1))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 3, y: 1))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 3, y: 10))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 12, y: 10))
        verticalAlignmentBottom2.addLine(to: CGPoint(x: 12, y: 1))
        verticalAlignmentBottom2.close()
        context.saveGState()
        UIColor.black.setFill()
        verticalAlignmentBottom2.fill()
        context.restoreGState()
    ...
    class func drawVerticalAlignmentFill(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 11, height: 11), resizing: ResizingBehavior = .aspectFit) {
        ...
        let horizontalAlignmentFill2 = UIBezierPath()
        horizontalAlignmentFill2.move(to: CGPoint(x: 11, y: 0))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 11, y: 11))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 0, y: 11))
        horizontalAlignmentFill2.addLine(to: CGPoint.zero)
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 11, y: 0))
        horizontalAlignmentFill2.close()
        horizontalAlignmentFill2.move(to: CGPoint(x: 10, y: 1))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 5.55, y: 1))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 7.8, y: 4.03))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 6.92, y: 4.36))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 6, y: 3))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 6, y: 8))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 7.11, y: 6.53))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 7.93, y: 6.95))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 5.49, y: 9.93))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 3.08, y: 6.69))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 3.97, y: 6.36))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 5, y: 8))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 5, y: 3))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 3.86, y: 4.34))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 3.07, y: 3.89))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 5.43, y: 1))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 1, y: 1))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 1, y: 10))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 10, y: 10))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 10, y: 1))
        horizontalAlignmentFill2.close()
        context.saveGState()
        UIColor.black.setFill()
        horizontalAlignmentFill2.fill()
        context.restoreGState()
    ...
    class func drawHorizontalAlignmentFill(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 11, height: 11), resizing: ResizingBehavior = .aspectFit) {
        ...
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 10, y: 1))
        horizontalAlignmentFill2.close()
        horizontalAlignmentFill2.move(to: CGPoint(x: 7.02, y: 3))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 10, y: 5.44))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 6.77, y: 7.85))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 6.44, y: 6.96))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 8, y: 6))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 3, y: 6))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 4.41, y: 7.07))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 3.96, y: 7.86))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 1, y: 5.44))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 4.1, y: 3.12))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 4.43, y: 4.01))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 3, y: 5))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 8, y: 5))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 6.61, y: 3.82))
        horizontalAlignmentFill2.addLine(to: CGPoint(x: 7.02, y: 3))
        horizontalAlignmentFill2.close()
        context.saveGState()
        UIColor.black.setFill()
        horizontalAlignmentFill2.fill()
    ...
    class func drawHorizontalAlignmentRight(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 11, height: 15), resizing: ResizingBehavior = .aspectFit) {
        ...
        let horizontalAlignmentRight2 = UIBezierPath()
        horizontalAlignmentRight2.move(to: CGPoint(x: 11, y: 15))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 10, y: 15))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 10, y: 13))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 0, y: 13))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 0, y: 2))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 10, y: 2))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 10, y: 0))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 11, y: 0))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 11, y: 15))
        horizontalAlignmentRight2.close()
        horizontalAlignmentRight2.move(to: CGPoint(x: 10, y: 3))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 1, y: 3))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 1, y: 12))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 10, y: 12))
        horizontalAlignmentRight2.addLine(to: CGPoint(x: 10, y: 3))
        horizontalAlignmentRight2.close()
        context.saveGState()
        UIColor(hue: 0.583, saturation: 0.095, brightness: 0.082, alpha: 1).setFill()
        horizontalAlignmentRight2.fill()
        context.restoreGState()
    ...
    class func drawHorizontalAlignmentTrailing(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 11, height: 15), resizing: ResizingBehavior = .aspectFit) {
        ...
        let horizontalAlignmentTrailing2 = UIBezierPath()
        horizontalAlignmentTrailing2.move(to: CGPoint(x: 11, y: 15))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 10, y: 15))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 10, y: 13))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 0, y: 13))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 0, y: 2))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 10, y: 2))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 10, y: 0))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 11, y: 0))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 11, y: 15))
        horizontalAlignmentTrailing2.close()
        horizontalAlignmentTrailing2.move(to: CGPoint(x: 10, y: 3))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 1, y: 3))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 1, y: 12))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 10, y: 12))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 10, y: 3))
        horizontalAlignmentTrailing2.close()
        horizontalAlignmentTrailing2.move(to: CGPoint(x: 8, y: 5))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 8, y: 6))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 6, y: 6))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 6, y: 10))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 5, y: 10))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 5, y: 6))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 3, y: 6))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 3, y: 5))
        horizontalAlignmentTrailing2.addLine(to: CGPoint(x: 8, y: 5))
        horizontalAlignmentTrailing2.close()
        context.saveGState()
        UIColor(hue: 0.583, saturation: 0.095, brightness: 0.082, alpha: 1).setFill()
        horizontalAlignmentTrailing2.fill()
        context.restoreGState()
    ...
    class func drawHorizontalAlignmentCenter(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 11, height: 15), resizing: ResizingBehavior = .aspectFit) {
        ...
        let horizontalAlignmentCenter2 = UIBezierPath()
        horizontalAlignmentCenter2.move(to: CGPoint(x: 6, y: 0))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 6, y: 2))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 11, y: 2))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 11, y: 13))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 6, y: 13))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 6, y: 15))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 5, y: 15))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 5, y: 13))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 0, y: 13))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 0, y: 2))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 5, y: 2))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 5, y: 0))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 6, y: 0))
        horizontalAlignmentCenter2.close()
        horizontalAlignmentCenter2.move(to: CGPoint(x: 5, y: 3))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 1, y: 3))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 1, y: 12))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 5, y: 12))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 5, y: 3))
        horizontalAlignmentCenter2.close()
        horizontalAlignmentCenter2.move(to: CGPoint(x: 10, y: 3))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 6, y: 3))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 6, y: 12))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 10, y: 12))
        horizontalAlignmentCenter2.addLine(to: CGPoint(x: 10, y: 3))
        horizontalAlignmentCenter2.close()
        context.saveGState()
        UIColor(hue: 0.583, saturation: 0.095, brightness: 0.082, alpha: 1).setFill()
        horizontalAlignmentCenter2.fill()
        context.restoreGState()
    ...
    class func drawHorizontalAlignmentLeft(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 11, height: 15), resizing: ResizingBehavior = .aspectFit) {
        ...
        let horizontalAlignmentLeft2 = UIBezierPath()
        horizontalAlignmentLeft2.move(to: CGPoint(x: 1, y: 0))
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 1, y: 2))
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 11, y: 2))
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 11, y: 13))
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 1, y: 13))
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 1, y: 15))
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 0, y: 15))
        horizontalAlignmentLeft2.addLine(to: CGPoint.zero)
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 1, y: 0))
        horizontalAlignmentLeft2.close()
        horizontalAlignmentLeft2.move(to: CGPoint(x: 10, y: 3))
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 1, y: 3))
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 1, y: 12))
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 10, y: 12))
        horizontalAlignmentLeft2.addLine(to: CGPoint(x: 10, y: 3))
        horizontalAlignmentLeft2.close()
        context.saveGState()
        UIColor(hue: 0.583, saturation: 0.095, brightness: 0.082, alpha: 1).setFill()
        horizontalAlignmentLeft2.fill()
        context.restoreGState()
    ...
    class func drawHorizontalAlignmentLeading(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 11, height: 15), resizing: ResizingBehavior = .aspectFit) {
        ...
        let horizontalAlignmentLeading2 = UIBezierPath()
        horizontalAlignmentLeading2.move(to: CGPoint(x: 1, y: 0))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 1, y: 2))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 11, y: 2))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 11, y: 13))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 1, y: 13))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 1, y: 15))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 0, y: 15))
        horizontalAlignmentLeading2.addLine(to: CGPoint.zero)
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 1, y: 0))
        horizontalAlignmentLeading2.close()
        horizontalAlignmentLeading2.move(to: CGPoint(x: 10, y: 3))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 1, y: 3))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 1, y: 12))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 10, y: 12))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 10, y: 3))
        horizontalAlignmentLeading2.close()
        horizontalAlignmentLeading2.move(to: CGPoint(x: 5, y: 5))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 5, y: 9))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 7, y: 9))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 7, y: 10))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 4, y: 10))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 4, y: 5))
        horizontalAlignmentLeading2.addLine(to: CGPoint(x: 5, y: 5))
        horizontalAlignmentLeading2.close()
        context.saveGState()
        UIColor(hue: 0.583, saturation: 0.095, brightness: 0.082, alpha: 1).setFill()
        horizontalAlignmentLeading2.fill()
        context.restoreGState()
